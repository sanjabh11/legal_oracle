...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE polname = 'Users can view their own profile' AND tablename = 'profiles'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policy 
    WHERE polname = 'Users can update their own profile' AND tablename = 'profiles'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policy 
    WHERE polname = 'Users can insert their own profile' AND tablename = 'profiles'
  ) THEN
